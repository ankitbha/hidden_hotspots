...
cols_train, cols_test = train_test_split(cols, test_size=float(prop), random_state=42)
...
df_interp.to_csv("missing_sensors_interpolated_{}.csv".format(prop))
df_null.to_csv("missing_sensors_{}.csv".format(prop))