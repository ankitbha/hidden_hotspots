...
def process_row(idx, row):
    ...
    x_train, x_test, y_train, y_test, z_train, z_test, vals_train, vals_test, cols_train, cols_test = train_test_split(
        x, y, z, vals, cols, test_size=prop, random_state=seed
    )
...
df_interp.to_csv("intermediate_data/{}%_random_sensor_failure_interpolated_seed_{}.csv".format(prop*100, seed))
df_null.to_csv("intermediate_data/{}%_random_sensor_failure_incomplete_seed_{}.csv".format(prop*100, seed))